...
#每日平均量
print("每日平均销售量是：",round((T+C+F+N+P+Y)/30,1))
print("   ")

print(T+C+F+N+P+Y)
#各种商品销售占比
print("T血销售数量占比：{:.0%}".format(T/(T+C+F+N+P+Y)))
print("衬衫销售数量占比：{:.0%}".format(C/(T+C+F+N+P+Y)))
print("风衣销售数量占比：{:.0%}".format(F/(T+C+F+N+P+Y)))
print("牛仔裤销售数量占比：{:.0%}".format(N/(T+C+F+N+P+Y)))
print("皮草销售数量占比：{:.0%}".format(P/(T+C+F+N+P+Y)))
print("羽绒服销售数量占比：{:.0%}".format(Y/(T+C+F+N+P+Y)))